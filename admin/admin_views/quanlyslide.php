                            ...
                            <div class="row">
                                <form id="form-add-ajax" action="" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <input name="cate_name" type="text" id="name-cate" onkeyup="ChangeToSlug();" class="form-control" placeholder="Tên danh mục">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
        ...
        <section id="context-menu">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Danh mục hiện có</h4>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center ">
                                                <button class="btn btn-outline-success btn-sm "><a href="./index.php?ctrl=suaslide&id=<?=$value['id']?>"><i data-feather="edit"></i></a></button>
                                                <button class="btn btn-outline-danger btn-sm"><a onclick="return Del('<?= $value['name']?>')" href="./index.php?ctrl=xoaslide&id=<?=$value['id']?>"><i  data-feather="delete"></i></a></button>
                                            </div>  
...
<script>
    function Del(name)
    {
        return confirm('Bạn có muốn xóa slide '+ name + "?");
    }
</script>
