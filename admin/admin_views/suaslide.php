                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="./quanlydanhmuc.html">Quản lý Slide</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <form id="form-add-ajax" action="" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <input name="cate_name" type="text" value="<?=$get_id['name']?>" id="name-cate" onkeyup="ChangeToSlug();" class="form-control" placeholder="Tên Slide">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                    ...
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <img style="width:200px" src="/uploads/img/<?=$get_id['img']?>" alt="">
                                    </div>
