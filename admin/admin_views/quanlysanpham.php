                            ...
                            <div class="row">
                                <form id="form-add-ajax" action="" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <input name="cate_name" type="text" id="name-cate" onkeyup="ChangeToSlug();" class="form-control" placeholder="Tên sản phẩm">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                    ...
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <input  name="price_sale" type="text" class="form-control" id="price_sale" placeholder="Nhập giá khuyến mãi">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        <label for="">Giá sản phẩm</label>
                                        <input  name="price" type="text" class="form-control" id="price_sale" placeholder="Nhập giá sản phẩm">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        <label for="">Mô tả</label>
                                        <textarea class="form-control" name="text" id="input" rows="3" required="required"></textarea>
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        <label for="">Size</label>
                                        <input  name="size" type="text" class="form-control" id="price_sale" placeholder="Nhập giá sản phẩm">
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        <label for="">Số lượng</label>
                                        <input  name="quantity" type="text" class="form-control" id="price_sale" placeholder="Nhập giá sản phẩm">
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card card-company-table">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php foreach($categ as $key => $value) { $img = explode('|',$value['img']);?>
                                    <tr>
                                        <td><?=$value['id']?></td>
                                        <td><?=$value['name']?></td>
                                        <td><?=$value['slug']?></td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    ...
                                                    <div class="avatar-content">
                                                        <img style="width:50px" src="<?=$img[0]?>" alt="Rocket svg" />
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center ">
                                                <button class="btn btn-outline-success btn-sm "><a href="./index.php?ctrl=suasanpham&id=<?=$value['id']?>"><i data-feather="edit"></i></a></button>
                                                <button class="btn btn-outline-danger btn-sm"><a onclick="return Del('<?= $value['name']?>')" href="./index.php?ctrl=xoasanpham&id=<?=$value['id']?>"><i  data-feather="delete"></i></a></button>
                                            </div>  
                                        </td>
                                        <?php ?>
                                    </tr>
