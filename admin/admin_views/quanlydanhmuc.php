                            ...
                            <div class="row">
                                <form id="form-add-ajax" action="" method="POST" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        ...
                                        <label class="form-control" for=""><input type="radio" name="status" id="status" value="1">Bảo trì</label>                                    
                                    </div>
                                    <div class="col-sm-12 col-lg-6 mb-2">
                                        <label for="">Hình ảnh
                                        <p class="card-text">
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img style="width:40px" src="../uploads/img/<?=$value['img']?>" alt="Rocket svg" />
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center ">
                                                ...
                                                <button class="btn btn-outline-danger btn-sm"><a onclick="return Del('<?= $value['name']?>')" href="./index.php?ctrl=xoadanhmuc&id=<?=$value['id']?>"><i  data-feather="delete"></i></a></button>
                                            </div>  
                                        </td>
                                        <?php ?>
                                    </tr>
